...
Interpretation of visual isn't clear for the Cohort analysis

```{r}
ggplot(data_cohort, aes(x = as.factor(name), y = value, color = as.factor(cohort), group = cohort)) + geom_line() + geom_point()
```
