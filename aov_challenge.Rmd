...
The AOV drastically reduced from **\$3,145 to \$300 dollars.** AOV is easily affected by outliers. In this dataset, if outliers are removed, AOV would be a good metric
