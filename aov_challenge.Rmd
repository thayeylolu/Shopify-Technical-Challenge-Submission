...
-   What Should matter to the store is if they are able to retain customers. Given the time period of the data set, it would be diffcult to calculate customer retention.
